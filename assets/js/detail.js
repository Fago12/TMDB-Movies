...
const recommendationURL = `https://api.themoviedb.org/3/movie/${movieId}/recommendations?api_key=${api_key}&page=1`;

// get genres, cast, directors, videos
...
fetchDataFromServer(url, function (movie) {
  const {
    backdrop_path,
    poster_path,
    title,
